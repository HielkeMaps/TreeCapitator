...
function tc:axe/register {score: "netherite_axe", namespace:"minecraft", name: "Netherite Axe", max_damage: 2031}
function tc:axe/register {score: "diamond_axe", namespace:"minecraft",name: "Diamond Axe", max_damage: 1561}
function tc:axe/register {score: "golden_axe", namespace:"minecraft",name: "Golden Axe", max_damage: 32}
function tc:axe/register {score: "iron_axe", namespace:"minecraft",name: "Iron Axe", max_damage: 250}
function tc:axe/register {score: "stone_axe", namespace:"minecraft", name: "Stone Axe", max_damage: 131}
function tc:axe/register {score: "wooden_axe", namespace:"minecraft", name: "Wooden Axe", max_damage: 59}
