...
function treecapitator:z_run/trees/dark_oak/validate/loop
execute if score ValidTree tc.value matches 1 run function treecapitator:z_run/trees/dark_oak/validate/whenvalid