...
function treecapitator:z_run/trees/spruce/validate/loop
execute if score ValidTree tc.value matches 1 run function treecapitator:z_run/trees/spruce/validate/whenvalid