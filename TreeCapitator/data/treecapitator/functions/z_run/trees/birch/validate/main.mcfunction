...
function treecapitator:z_run/trees/birch/validate/loop
execute if score ValidTree tc.value matches 1 run function treecapitator:z_run/trees/birch/validate/whenvalid