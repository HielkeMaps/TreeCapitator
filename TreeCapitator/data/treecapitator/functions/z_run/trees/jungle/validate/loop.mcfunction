...
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~ if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~1 if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~ ~1 ~-1 if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~ if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~1 if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~1 ~1 ~-1 if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~ if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~1 if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop
execute if score ValidTree tc.value matches 0 positioned ~-1 ~1 ~-1 if block ~ ~ ~ minecraft:jungle_log run function treecapitator:z_run/trees/jungle/validate/loop